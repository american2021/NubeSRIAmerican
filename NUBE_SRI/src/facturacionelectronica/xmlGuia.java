...
public class xmlGuia {
    ...
    List<detallePagos> pagos = new ArrayList<>();
    ...
    public String generarXML(){
        ...
        xml = ""+
            ...
            for (int i = 0; i < pagos.size(); i++) {
                ...
                "            <pago>\n" +
                "                <formaPago>"+pagos.get(i).formaPago+"</formaPago>\n" +
                "                <total>"+pagos.get(i).total+"</total>\n" +
                "            </pago>\n";
            }
            xml=xml+detallePagos+
            "        </pagos>\n" +
            "    </infoFactura>\n" +
            "    <detalles>\n";
    ...
    public List<detallePagos> getPagos() {
        return pagos;
    }

    public void setPagos(List<detallePagos> pagos) {
        this.pagos = pagos;
    }
