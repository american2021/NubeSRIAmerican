        ...
        if (correo != null) {
            if (correo.length() > 0) {
                try {
                    ...
                    props.setProperty("mail.smtp.user", "facturascoradac@hotmail.com");
                    ...
                    message.setFrom(new InternetAddress("facturascoradac@hotmail.com"));
                    ...
                    t.connect("facturascoradac@hotmail.com", "coradac2019");
