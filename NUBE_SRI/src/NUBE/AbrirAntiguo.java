...
public class AbrirAntiguo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        usuario.setForeground(new java.awt.Color(0, 51, 153));
    ...
    public void acepta(){
        ...
        String query = "SELECT CLAVEFIRMA FROM appl..USUARIOS WHERE USUARIO = '"+usu+"' AND CLAVE = '"+con+"'";
        ...
        if(claveFirma!=null){
            if(claveFirma.length()>0){
                ...
                String baseGE = "";
                String IECabTipo = "";
                if(usu.equals("0190426513001")){
                        empresa = "Instituto";
                        baseVF = "vfIA";
                        baseGE = "geIA";
                        IECabTipo = "I";
                }else if(usu.equals("0102365491001")){
                        empresa = "BillGates";
                        baseVF = "vfBG";
                        baseGE = "geBG";
                        IECabTipo = "B";
                }else if(usu.equals("0190408051001")){
                        empresa = "Coradac";
                        baseVF = "vfCA";
                        baseGE = "geCA";
                        IECabTipo = "I";
                }else if (usu.equals("0190427269001")){
                        empresa = "Corel";
                        baseVF = "vfCO";
                        baseGE = "geCO";
                        IECabTipo = "C";
                }
                NUBE_ELECTRONICA_AMERICAN_Antiguo nube = new NUBE_ELECTRONICA_AMERICAN_Antiguo(empresa, claveFirma, baseVF, baseGE, IECabTipo);
                this.dispose();
...
//        //fin aux
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AbrirAntiguo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new AbrirAntiguo().setVisible(true);
            }
        });
    }
